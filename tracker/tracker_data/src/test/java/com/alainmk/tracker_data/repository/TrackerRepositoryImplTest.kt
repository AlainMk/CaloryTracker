...
import com.alainmk.tracker_data.remote.malformedFoodResponse
import com.alainmk.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    fun `Search food, valid response, return results`() = runBlocking {
        ...
        val result = repository.searchFood("banana", 1, 30)
